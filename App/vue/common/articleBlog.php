<div id="container_blog">
    ...
    <div id="container_articles">
        ...
        <div id="article">
            <a href="https://shihan.needemand.com/projets_web/la_fleur_wordpress/?p=1">
                <img src="./public/assets/img/blog/abielles.jpg" alt="phoho abielle"> </a>
            <p>La semaine des abeilles</p>
        </div>
    </div>
</div>