...
<?php
    foreach ($lesArticlesMariage as $unArticle) {
        ...
        <div id="container_article">
            ...
            <div id="description_article">
                ...
                <div id="prix_panier">
                    ...
                    <a href="index.php?page=v_mariage&idArticle=<?php echo $idArticle ?>&categorie=Mariage&action=ajouterAuPanierMariage">
...
<div id="container_all_article_repture">
       ...
       if (isset($lesArticlesEnReptureMariage)) {
        foreach ($lesArticlesEnReptureMariage as $unArticle) {
            $idArticle = $unArticle['id'];
            $description = $unArticle['description'];
            $etat = $unArticle['etat'];
            $prix = $unArticle['prix_unitaire'];
